...
public class SignupNFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_signup_n, container, false);
                        ...
                        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    accounts= new Accounts(name, number, email,"Empty","NeedsFasaa");
                                    ...
                                    mDatabase.getReference("Accounts").child(mUser.getUid()).setValue(accounts).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            Intent intent=new Intent(getContext(), MainNeedHelpActivity.class);
